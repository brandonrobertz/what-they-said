  ...
  render: function() {
    ...
    if(!this.props.selectedVideo) {
      return <div id="noVideoSelected">
          ...
          <div className="subtitle">search hundreds of campaign speeches</div>
        </div>;
    }
    ...
    var url = 'https://www.youtube.com/embed/' + vid +
      '?start=' + s + '&end=' + e + '&cc_load_policy=1&autoplay=1&controls=0&hl=en';
    return (
      <div id="playVideo">
      <iframe
        src={url}
